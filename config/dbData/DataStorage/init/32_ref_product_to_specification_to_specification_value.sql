...
ALTER TABLE public.ref_product_to_specification_to_specification_value ADD CONSTRAINT ref_pssv_product_id_fkey FOREIGN KEY (product_id) REFERENCES public.product(id);
