...
type repository interface {
	...
	Create(ctx context.Context, productCategory *ProductCategory) (*model.ProductCategory, error)
	Get(ctx context.Context, id string) (*ProductCategory, error)
	GetByURL(ctx context.Context, url string) (*ProductCategory, error)
	Update(ctx context.Context, productCategory *ProductCategory) (*ProductCategory, error)
