...
var (
	NoName = validation.NewValidation("Name is required", "Name is required", "884jds", "name")
	NoUrl  = validation.NewValidation("Url is required", "Url is required", "0poy5p", "url")
)
