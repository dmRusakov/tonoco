...
var (
	NoName         = validation.NewValidation("Name is required", "Name is required", "282341", "Name")
	NoAbbreviation = validation.NewValidation("Abbreviation is required", "Abbreviation is required", "282342", "Abbreviation")
	NoAddressLine1 = validation.NewValidation("Address Line 1 is required", "Address Line 1 is required", "282344", "AddressLine1")
	NoCity         = validation.NewValidation("City is required", "City is required", "282345", "City")
	NoState        = validation.NewValidation("State is required", "State is required", "282346", "State")
	NoZipCode      = validation.NewValidation("Zip Code is required", "Zip Code is required", "282347", "ZipCode")
	NoCountry      = validation.NewValidation("Country is required", "Country is required", "282348", "Country")
