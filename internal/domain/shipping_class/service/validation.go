...
var (
	NoName = validation.NewValidation("Name is required", "Name is required", "sdlfj3", "name")
	NoUrl  = validation.NewValidation("Url is required", "Url is required", "okcSfs", "url")
)
